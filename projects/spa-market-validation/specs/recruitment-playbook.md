...
| Step | When |
|------|------|
| Confirm interview completed (45+ min) | Day of call |
| Send gift card within 3 business days | After call |
| Add to pilot waitlist | After call |
| Grant pilot access | When product ready |

## Quality mix

Aim for diversity within each region:

- 2–3 solo artists (1 chair)
- 3–4 small salons (2–5 chairs)
- Mix of IG-heavy and Facebook/Zalo-heavy (VN)
